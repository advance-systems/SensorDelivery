...
import { PedidoResponse, StatusPedido } from '../types';
...
const STEPS: { status: StatusPedido; label: string; desc: string; icon: any }[] = [
  {
    status: 'NOVO',
...
export const OrderTrackingScreen: React.FC<OrderTrackingScreenProps> = ({
  ...
  const getStatusIndex = (status?: StatusPedido): number => {
    switch (status) {
      case 'RASCUNHO':
      case 'NOVO':
        return 0;
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      {carregando && !pedido ? (
        ...
        >
          ...
          {/* Stepper Vertical (Idêntico ao layout Delphi uFrameAcompanharPedido) */}
